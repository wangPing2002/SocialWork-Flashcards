...
public class MainActivity extends Activity {
    ...
    CardRepository repo; StudyStore store; ReviewEngine engine;
    ...
    @Override public void onCreate(Bundle b){
        ...
        try{repo=new CardRepository(this);store=new StudyStore(this);engine=new ReviewEngine(store);showHome();}
